...
#pragma pack(pop)
	...
	{
		this->Nodes.Emplace(HeaderFileIdNode.first).Properties.EmplaceBack('R', &string(HeaderFileIdNode.second));
		this->Nodes.Emplace(HeaderCreationTimeNode.first).Properties.EmplaceBack('S', &string(HeaderCreationTimeNode.second));
		this->Nodes.Emplace(HeaderExtensionCreatorProperty.first).Properties.EmplaceBack('S', &string(HeaderExtensionCreatorProperty.second));
	}
